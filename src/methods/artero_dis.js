/**
 * This js file implements the similarity-based ordering methods, but uses dissimilarity instead of similarity
...
import { getMaxDim, getMinDim, getCol, getMinIndex } from "../basics/auxiliary";

/**
 * get the neighboring sequence when applying the ordering method by artero et al.
 * @param simMat
 */
export function artero_dis(simMat) {
